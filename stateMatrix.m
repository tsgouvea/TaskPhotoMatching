...
sma = AddState(sma, 'Name', 'baseline',...
    'Timer', TaskParameters.GUI.BaselineDur,...
...
if TaskParameters.GUI.Photometry || strcmp('TruncExp',TaskParameters.GUIMeta.FeedbackDelaySelection.String{TaskParameters.GUI.FeedbackDelaySelection})
